...
class DijkstraPlanner:
    ...
    def plan(self, map_msg, start_pose, goal_pose):
        """
        Plans a path on the occupancy grid map using Dijkstra's algorithm (uniform cost search).
        ...
        """
        self.logger.info("Dijkstra Path Planning started...")
        ...
        # Priority queue stores: (g_score, (x, y))
        open_set = []
        ...
        if not found:
            self.logger.warn("Dijkstra failed to find a valid path!")
            return []
