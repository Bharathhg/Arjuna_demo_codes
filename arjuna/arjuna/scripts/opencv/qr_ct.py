...
class QRController(Node):
    ...
    def laser_callback(self, msg):
        ...
        self.regions = {
            'front_left':  get_region_min(0, 60),     # 0-60°
            'front_right': get_region_min(300, 360),   # 300-360°
            'f_left':      get_region_min(60, 120),    # 60-120°
            'f_right':     get_region_min(240, 300)    # 240-300°
        }
