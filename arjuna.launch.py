...
from launch.actions import DeclareLaunchArgument, ExecuteProcess, RegisterEventHandler, EmitEvent, IncludeLaunchDescription
...
def generate_launch_description():
    ...
    # Nav2 Navigation Stack (only in nav mode)
    nav2_params_file = os.path.join(pkg_arjuna, 'config', 'nav2_params.yaml')
    nav2_launch_file = os.path.join(pkg_arjuna, 'launch', 'nav2_navigation.launch.py')
    ...
    # SLAM Toolbox (only in slam mode)
